...
public class Test1 implements IFloodlightModule, IOFMessageListener, ITopologyListener {
    ...
    protected ISwitchStatisticsCollector statsService;
    ...
    public void init(FloodlightModuleContext context) throws FloodlightModuleException {
        ...
        statsService = context.getServiceImpl(ISwitchStatisticsCollector.class);
    }
...
//        System.out.println(statsService.getSwitchStatistics(sw.getId(), OFStatsType.GROUP).toString());
    ...
    private class TestMeter implements Runnable {
        ...
        @Override
        public void run() {
            TestForMeter testForMeter = new TestForMeter(meterService, switchService, logger, floodlightProvider,
                    statsService);
            testForMeter.startTest();
        }
    }
