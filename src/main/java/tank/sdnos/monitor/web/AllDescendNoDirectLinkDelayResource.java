...
public class AllDescendNoDirectLinkDelayResource extends ServerResource {
    ...
    public NoDirectLinkDelayArray getTopNDelayNoDirectLinksResource() {
        ...
        return new NoDirectLinkDelayArray(delayMonitorService.getAllDescendDelayNoDirectLinks());
    }
}
