...
public class AllDescendNoDirectLinkLossResource extends ServerResource {
    ...
    public NoDirectLinkLossArray getTopNLossNoDirectLinksResource() {
        ...
        return new NoDirectLinkLossArray(lossMonitorService.getAllDescendLossNoDirectLinks());
    }
}
